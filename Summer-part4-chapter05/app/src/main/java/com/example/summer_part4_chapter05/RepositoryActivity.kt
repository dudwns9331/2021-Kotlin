...
import com.example.summer_part4_chapter05.data.database.DataBaseProvider
import com.example.summer_part4_chapter05.data.entity.GithubRepoEntity
import com.example.summer_part4_chapter05.databinding.ActivityRepositoryBinding
import com.example.summer_part4_chapter05.extensions.loadCenterInside
...
class RepositoryActivity : AppCompatActivity(), CoroutineScope {
    ...
    private fun setLikeState(githubRepoEntity: GithubRepoEntity) = launch {
        withContext(Dispatchers.IO) {
            val repository = DataBaseProvider.provideDB(this@RepositoryActivity).searchHistoryDao()
